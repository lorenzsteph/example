package it.almaviva.queue.encrypt;
...
@ContextConfiguration(locations = { "classpath:it/almaviva/queue/encrypt/encrypt-test-context.xml" })
public class TestEncrypt {
	...
	public void testStandardEncrypt() {
		...
		encryptor.setPassword("almaviva"); // we HAVE TO set a password
